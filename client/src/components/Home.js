...
const Home = () => {
  return (
    <main>
      ...
      <Link to='/Games/1/' className='nav-link'><img id='gameImage' src={'https://i.pinimg.com/564x/d5/2e/4d/d52e4d3294e81140687b04b70a0cf8ac.jpg'} alt='Game' /></Link>
      ...
      <Link to='/Characters/1/' className='nav-link'><img id='characterImage' src={'https://i.pinimg.com/564x/f7/77/8a/f7778a54d67b547f1fb93e4e04e38d00.jpg'} alt='Character' /></Link>
